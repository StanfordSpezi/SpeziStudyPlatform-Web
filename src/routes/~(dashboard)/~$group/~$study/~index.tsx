...
const StudyHomeRoute = () => {
  return (
    <div className="flex-center size-full w-full p-6 pb-32">
        ...
        <Card>
          ...
          <div className="space-y-4 p-(--card-padding)">
            <p className="text-text-secondary text-sm leading-relaxed">
              This open-source project helps researchers define studies by
              specifying metadata, participant criteria, and app components.
              These study definitions configure companion iOS and Android apps
              that participants use to take part in the study.
            </p>
